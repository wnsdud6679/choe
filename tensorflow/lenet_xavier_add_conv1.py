...
#W_conv3 = weight_variable([5, 5, 50, 80])
W_conv3 = tf.get_variable("W_conv3", shape=[5, 5, 50, 80],
           initializer=tf.contrib.layers.xavier_initializer())
...
W_fc1 = tf.get_variable("W_fc1", shape=[7 * 7 * 80, 500], initializer=tf.contrib.layers.xavier_initializer())
b_fc1 = bias_variable([500])
h_pool2_flat = tf.reshape(h_conv3, [-1, 7*7*80])
